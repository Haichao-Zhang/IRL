...
from inverse_rl.models.imitation_learning import OTIRLStateAction
...
def main():
    ...
    irl_model = OTIRLStateAction(env_spec=env.spec, expert_trajs=experts,
                                 discrim_arch_args={'dout': 10})
    ...
    with rllab_logdir(algo=algo, dirname='data/pendulum_oil'):
        with tf.Session():
            algo.train()
